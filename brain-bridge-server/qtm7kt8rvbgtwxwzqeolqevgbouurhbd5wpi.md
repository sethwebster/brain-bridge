...
*   [`renderToPipeableStream`](server/renderToPipeableStream.html) renders a React tree to a pipeable [Node.js Stream.](https://nodejs.org/api/stream.html)
*   [`renderToStaticNodeStream`](server/renderToStaticNodeStream.html) renders a non-interactive React tree to a [Node.js Readable Stream.](https://nodejs.org/api/stream.html#readable-streams)
...
*   [`renderToReadableStream`](server/renderToReadableStream.html) renders a React tree to a [Readable Web Stream.](https://developer.mozilla.org/en-US/docs/Web/API/ReadableStream)
...
*   [`renderToString`](server/renderToString.html) renders a React tree to a string.
*   [`renderToStaticMarkup`](server/renderToStaticMarkup.html) renders a non-interactive React tree to a string.
...
*   [`renderToNodeStream`](server/renderToNodeStream.html) renders a React tree to a [Node.js Readable stream.](https://nodejs.org/api/stream.html#readable-streams) (Deprecated.)

[PrevioushydrateRoot](client/hydrateRoot.html)[NextrenderToNodeStream](server/renderToNodeStream.html)
