...
Stable releases[](#stable-releases "Link for Stable releases ")
---------------------------------------------------------------
...
### Commitment to stability[](#commitment-to-stability "Link for Commitment to stability ")
...
### Gradual upgrades via warnings[](#gradual-upgrades-via-warnings "Link for Gradual upgrades via warnings ")
...
### What counts as a breaking change?[](#what-counts-as-a-breaking-change "Link for What counts as a breaking change? ")
...
### If a minor release includes no new features, why isn’t it a patch?[](#if-a-minor-release-includes-no-new-features-why-isnt-it-a-patch "Link for If a minor release includes no new features, why isn’t it a patch? ")
...
All release channels[](#all-release-channels "Link for All release channels ")
------------------------------------------------------------------------------
...
*   [**Canary**](#canary-channel) tracks the main branch of the React source code repository. Think of these as release candidates for the next semver release. **[Frameworks or other curated setups may choose to use this channel with a pinned version of React.](../blog/2023/05/03/react-canaries.html) You can also Canaries for integration testing between React and third party projects.**
...
*   Canary releases [must be pinned](../blog/2023/05/03/react-canaries.html) and may include breaking changes. They exist for curated setups (like frameworks) that want to gradually release new React features and bugfixes on their own release schedule.
...
### Latest channel[](#latest-channel "Link for Latest channel ")
...
### Canary channel[](#canary-channel "Link for Canary channel ")
...
**Do not use prereleases in user-facing applications directly unless you’re following the [Canary workflow](../blog/2023/05/03/react-canaries.html).**
...
#### Using the canary channel for integration testing[](#using-the-canary-channel-for-integration-testing "Link for Using the canary channel for integration testing ")
...
### Experimental channel[](#experimental-channel "Link for Experimental channel ")
...
#### What goes into an experimental release?[](#what-goes-into-an-experimental-release "Link for What goes into an experimental release? ")
...
#### How can I learn more about experimental features?[](#how-can-i-learn-more-about-experimental-features "Link for How can I learn more about experimental features? ")
...
We will post to the [React blog](../blog.html) when we’re ready to announce new experiments, but that doesn’t mean we will publicize every experiment.
...
[PreviousAcknowledgements](acknowledgements.html)
