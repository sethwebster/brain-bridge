...
import { SimilaritySearchResult, SimilaritySearcher } from "./SimilaritySearchResult";
import { WeviateSimilaritySearcherResponse } from "./llm";
import weaviate, { WeaviateClient } from 'weaviate-ts-client';

invariant(process.env.WEAVIATE_HOST, "WEAVIATE_HOST must be set in .env");
