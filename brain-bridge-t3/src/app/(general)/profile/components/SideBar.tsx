...
import { UrlIcon } from "~/app/components/SvgIcons";
...
export default function SideBar({
  ...
  return (
    <>
      ...
      <aside
        id="default-sidebar"
        className=" fixed left-0 z-40 w-64 h-screen transition-transform -translate-x-full top-20 sm:translate-x-0 shadow"
        aria-label="Sidebar"
      >
